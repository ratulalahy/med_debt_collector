...
class VapiDebtCollector:
    ...
    def make_outbound_call(self, customer_name: str, customer_number: str, balance: float, customer_id: str) -> Dict[str, Any]:
        # payload = {
        ...
        # }
        payload = {
            "workflowId": os.getenv("DEBT_COLLECTION_WORKFLOW_ID"),
            "phoneNumberId": self.phone_number_id,
            "customer": {
        ...
        #     #     "eventTypes": ["call.ended", "call.transcript.created", "call.analysis.completed"]
        #     # }
        # }
    ...
    def run_full_call_flow(self, customer_name: str, customer_number: str, balance: float, customer_id: str):
        result = self.make_outbound_call(customer_name, customer_number, balance, customer_id)
        ...
        import time
        time.sleep(10)  # in real apps, poll call status or webhook
        ...
        self.log_call_to_db(call_id, customer_number,
                            details.get("cost", 0.0), transcript)


if __name__ == "__main__":
    collector = VapiDebtCollector()
    collector.run_full_call_flow("Ratul","+15754181944", 100.50, "cust_001")
